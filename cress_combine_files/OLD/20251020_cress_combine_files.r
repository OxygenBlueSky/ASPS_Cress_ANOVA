...
# Data quality notes:
# 1. ASPS1 data includes both "gerade" (even) and "ungerade" (odd) numbered samples
# 2. ASPS2 has two "gerade" files from different dates (20251003 and 20251020) - both included
